...
make realclean && make AVX=3 MIC=0 OMP=1 STATIC=1 -j
CHECK=1 srun run_resnet50_no_first_layer_1x1.sh 56 100 1 f32 F L 1  > bn_kernel_check.txt
...
echo "#define USE_FUSE_LEVEL_KERNEL" >> bench_defines.h
make realclean && make AVX=3 MIC=0 OMP=1 STATIC=1 -j
CHECK=1 srun run_resnet50_no_first_layer_1x1.sh 56 100 1 f32 F L 1  > bn_eltwise_kernel_check.txt
